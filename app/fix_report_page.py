...
FIXES = [
    ...
    ("Средне", "#c78cff", "Языки", "Английский стал языком по умолчанию. В настройках оставлены три языка: English, Deutsch и Italiano, с улучшенными переводами основных экранов."),
